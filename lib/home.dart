...
createBook(String image, String title, String author) {
  return Padding(
  ...
  return Container(
    ...
    child: ListView(
      ...
      children: [
        ...
        createBook(
          'https://m.media-amazon.com/images/I/51amKTwzkPL.jpg',
        ...
        createBook(
          'https://m.media-amazon.com/images/I/51XULadddlL.jpg',
...
buildRowOfertas() {
  ...
  return Container(
    ...
    child: ListView(
      ...
      children: [
        createBook(
          'https://m.media-amazon.com/images/I/91rtArfzScL.jpg',
